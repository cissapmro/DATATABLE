            ...
            <div className="flex flex-column align-items-center justify-content-center">
                ...
                <div
                    style={{
                        borderRadius: '56px',
                        padding: '0.3rem',
                        background: 'linear-gradient(180deg, #00c1c4 10%, rgba(33, 150, 243, 0) 30%)'
                    }}
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        <div className="flex justify-content-center align-items-center bg-cyan-500 border-circle" style={{ height: '3.2rem', width: '3.2rem' }}>
